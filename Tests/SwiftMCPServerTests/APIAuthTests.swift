...
struct APIAuthTests {
    ...
    func testProtectedEndpointWithoutAuth() async throws {
        ...
        let url = try #require(URL(string: "http://localhost:9300/mcp"))
    ...
    func testProtectedEndpointWithValidAuth() async throws {
        ...
        let url = try #require(URL(string: "http://localhost:9301/mcp"))
        var request = URLRequest(url: url)
        request.httpMethod = "POST"
        request.setValue("application/json", forHTTPHeaderField: "Content-Type")
    ...
    func testPublicEndpointWithoutAuth() async throws {
        ...
        let url = try #require(URL(string: "http://localhost:9302/health"))
    ...
    func testServerInfoShowsAuthStatus() async throws {
        ...
        let url = try #require(URL(string: "http://localhost:9303/mcp"))
        let (data, response) = try await URLSession.shared.data(from: url)
    ...
    func testNoAuthenticator() async throws {
        ...
        let url = try #require(URL(string: "http://localhost:9304/mcp"))
        var request = URLRequest(url: url)
        request.httpMethod = "POST"
        request.setValue("application/json", forHTTPHeaderField: "Content-Type")
        // Use a notification (no "id") so the server returns 202 immediately
